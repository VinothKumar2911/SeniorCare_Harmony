...
"Explore our history, mission, team, and values through engaging content and captivating visuals on our About page."
        ...
        <h2 className='head11'>Insights into Our Journey, Team, and Mission</h2>
       <p className='head12'>"Explore Our Journey offers an in-depth look at our dedicated team, mission-driven approach,<br>
       </br> core values, and unwavering commitment to providing excellent care and service to our clients."</p>
       <div className='apple'>
      <div className='content'>
        <h2>20 Years of Experience in Home Care & Private Nursing</h2>
        <p>
  ...
  <div className='orange'>
    <h1 >Easy Steps To Get Our Sevices</h1>
    <p>
...
and begin enjoying our exceptional offerings without any hassle. Our user-friendly process ensures a smooth and efficient experience for all.</p>
  </div>
