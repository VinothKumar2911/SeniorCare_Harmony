...
public class BookingController {
    ...
    @GetMapping("/user")
    public ResponseEntity<List<BookingDetails>> getBookingsByphone(@RequestParam String phone) {
        List<BookingDetails> bookings = bookingService.getBookingsByphone(phone);
        return new ResponseEntity<>(bookings, HttpStatus.OK);
    }
